...
def pontaParaBaixo(x,pontos):
    ...
    if( (pontos[ant][0].y > x[0].y or (pontos[ant][0].y == x[0].y and pontos[ant][0].x < x[0].x)) and (pontos[prox][0].y > x[0].y  or (pontos[prox][0].y == x[0].y and pontos[prox][0].x < x[0].x)) ): return True
    else: return False
...
################
    ...
    for k in range(0,N):
        ...
        if( ( (pontos[ant][0].y < verts[k][0].y or (pontos[ant][0].y == verts[k][0].y and pontos[ant][0].x > verts[k][0].x)) and (verts[k][0].y < pontos[prox][0].y or (verts[k][0].y == pontos[prox][0].y and verts[k][0].x > pontos[prox][0].x )) or ( (pontos[prox][0].y < verts[k][0].y or (pontos[prox][0].y == verts[k][0].y and pontos[prox][0].x > verts[k][0].x))  and (verts[k][0].y < pontos[ant][0].y) or (verts[k][0].y == pontos[ant][0].y and verts[k][0].x > pontos[ant][0].x ))) ): #Caso 1: uma aresta acima e outra embaixo
        ...
        elif((pontos[ant][0].y < verts[k][0].y) or (pontos[ant][0].y == verts[k][0].y and pontos[ant][0].x > verts[k][0].x )): #Caso 2: as duas arestas embaixo
